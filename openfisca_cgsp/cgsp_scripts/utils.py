...
def graph(reform_module, year):
    ...
    def plot(simulation, reference_simulation = None, filename = None):
        ...
        graphs.draw_bareme(
            ...
            hide_all = True if reference_simulation is not None else False,
            )
        plt.show()
        if filename:
    ...
    filename = "figures/{}_reform".format(reform_name)
    plot(simulation = reform_simulation, filename = filename)

    filename = "figures/{}_reference".format(reform_name)
    plot(simulation = reference_simulation, filename = filename)

    filename = "figures/{}_diff".format(reform_name)
